...
class NokogiriLocatorFieldTest < NokogiriLocatorTest
  ...
  #   html = <<-html
  #     <label for="bar">Foo</label><select id="bar"></select>
  #     <label for="baz">Foo</label><input id="baz" type="checkbox" />
  #   html
  #   dom = dom(html)
  #   element = Locators::Field.new(dom, 'Foo', :type => 'checkbox').locate
  #   assert_equal 'checkbox', element.attribute('type')
  # end
end